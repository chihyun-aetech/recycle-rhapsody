  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={periodData}>
                ...
                />
                <Bar dataKey="dailyInflow" fill="#64748b" radius={[2, 2, 0, 0]} name={language === 'ko' ? '유입량' : 'Inflow'} />
                <Bar dataKey="processing" fill="#00A788" radius={[2, 2, 0, 0]} name={language === 'ko' ? '처리량' : 'Processed'} />
                <Bar dataKey="unprocessed" fill="#ef4444" radius={[2, 2, 0, 0]} name={language === 'ko' ? '미처리' : 'Unprocessed'} />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{language === 'ko' ? '픽업률 추이' : 'Pickup Rate Trend'}</CardTitle>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={periodData}>
                ...
                <Line 
                  ...
                  stroke="#f59e0b" 
                  strokeWidth={3}
                  name={language === 'ko' ? '픽업률 (%)' : 'Pickup Rate (%)'}
