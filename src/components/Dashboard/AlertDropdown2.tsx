...
const alertData = [
  ...
  },
  {
    ...
    logId: 'log-004',
    type: 'warning',
    message: '라인 3 카메라 센서 오류',
    timestamp: '2024-01-31 14:15:30',
    severity: 'warning'
  },
];

export const AlertDropdown2: React.FC = () => {
  const { language, setActiveTab, setFocusedLogId } = useDashboard2();
  ...
  const handleAlertClick = (alert: typeof alertData[0]) => {
    setActiveTab('monitoring');
    setFocusedLogId(alert.logId);
  };
